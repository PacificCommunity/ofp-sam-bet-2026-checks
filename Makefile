...
export BUNDLE_NAME BUNDLE_FRQ BUNDLE_FINAL_PAR_NAME BUNDLE_REPORT_OUTPUT_PAR BUNDLE_REPORT_SWITCHES BUNDLE_GENERATE_REPORTS BUNDLE_REQUIRE_PLOT_REP BUNDLE_ALLOW_REPORT_FAILURE BUNDLE_INCLUDE_EXE BUNDLE_EXE_NAME BUNDLE_VERIFY_ZIP_RUN
export TRIGGER_NEXT
