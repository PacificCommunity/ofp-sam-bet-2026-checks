...
export JITTER_SEEDS JITTER_SEED RETRO_PEELS RETRO_PEEL RETRO_MAKEPAR_START RETRO_REMOVE_PAR_FILES RETRO_START_PAR_NAME RETRO_REWRITE_PAR SELFTEST_REPS SELFTEST_REP
