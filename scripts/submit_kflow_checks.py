...
DEFAULT_RUNTIME_PACKAGES = (
    "mfclkit=PacificCommunity/ofp-sam-mfclkit@dea48f1e7dd77c14118bc67e27a3a8849f49dcee,"
    "mfclshiny=PacificCommunity/mfclshiny@be4b7aaea2540ce443000b96e374f10ecc91fccc"
)
            ...
            for unit in unit_specs:
                ...
                env = {
                    ...
                    **flow_metadata_env(),
                    ...
                    "KFLOW_RUNTIME_GITHUB_AUTH": os.environ.get("KFLOW_RUNTIME_GITHUB_AUTH", "false"),
                    "KFLOW_FORWARD_GITHUB_TOKEN_TO_RUNTIME": os.environ.get("KFLOW_FORWARD_GITHUB_TOKEN_TO_RUNTIME", "false"),
                }
                env_prefixes = (
