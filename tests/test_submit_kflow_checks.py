...
class AttachedTaskDefaultsTests(unittest.TestCase):
    ...
    def test_profile_task_keeps_chain_continuation_defaults(self):
        ...
        self.assertIn('CHECK_BUILD_PAYLOADS: "false"', task)
        self.assertIn('CHECK_BUILD_REPORT_FIGURES: "false"', task)
        self.assertIn('CHECK_REQUIRE_PAYLOAD_REFRESH: "false"', task)
